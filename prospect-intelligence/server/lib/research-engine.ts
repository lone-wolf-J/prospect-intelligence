...
export function resolveIdentity(query: string, candidate: any = null): Identity {
  ...
  if (!company) {
    // Multi-word entries first so "google cloud" beats "cloud", etc.
    const knownOrgs = ["palo alto networks", "dell technologies", "general motors", "girls who code", "google cloud", "goldman sachs", "morgan stanley", "johnson & johnson", "american airlines", "microsoft", "nvidia", "amd", "google", "alphabet", "ibm", "adobe", "tesla", "apple", "amazon", "aws", "meta", "intel", "oracle", "salesforce", "servicenow", "workday", "snowflake", "databricks", "palantir", "crowdstrike", "zscaler", "okta", "cloudflare", "datadog", "splunk", "elastic", "mongodb", "confluent", "hashicorp", "gitlab", "github", "atlassian", "asana", "notion", "figma", "autodesk", "cadence", "synopsys", "qualcomm", "broadcom", "micron", "marvell", "qorvo", "nxp", "infineon", "analog devices", "microchip", "arm", "ford", "toyota", "stanford", "mit", "harvard", "openai", "anthropic", "deepmind", "levelshift", "preludesys", "demandblue", "demanddynamics", "slack", "uber", "lyft", "airbnb", "spotify", "shopify", "canva", "stripe", "netflix", "disney", "nike", "walmart", "target", "costco", "delta", "united", "marriott", "hilton", "linkedin", "twitter", "facebook", "instagram", "youtube", "tiktok", "snapchat", "pinterest", "reddit", "zoom", "dropbox", "box", "hubspot", "zendesk", "coinbase", "robinhood", "doordash", "instacart", "spacex", "deloitte", "accenture", "mckinsey", "jpmorgan", "cisco", "dell", "samsung", "sony", "siemens", "boeing", "fedex", "ups", "pfizer", "moderna", "merck"]; // trailing-company parse
